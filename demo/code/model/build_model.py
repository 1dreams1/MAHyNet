...
def build_model_one(model_template, number_of_kernel, kernel_length, input_shape, local_window_size=19):
...
def build_model_two(model_template, number_of_kernel, kernel_length, input_shape, local_window_size=19):
        def Relu(x):
            return keras.backend.relu(x, alpha=0.5, max_value=10)
